...
\usepackage{lmodern,xcolor,enumitem,tabularx,array,titlesec,microtype,lastpage,fancyhdr,graphicx}
...
\begin{document}
\begin{minipage}[t]{0.50\linewidth}\vspace{0pt}\raggedright
{\fontsize{23}{27}\selectfont\bfseries Tworit Kumar Dash}\\[3pt]
{\large\color{clay}\textbf{Model-Based Inference Researcher}}
\end{minipage}\hfill
\begin{minipage}[t]{0.27\linewidth}\vspace{0pt}\raggedleft\small
...
\end{minipage}\hfill
\begin{minipage}[t]{0.14\linewidth}\vspace{-2mm}\raggedleft
\includegraphics[width=26mm,trim=150 38 150 38,clip]{Tworit.jpg}
\end{minipage}
